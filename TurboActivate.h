...
/*
 ...
 forever.
 */
#define TA_DISALLOW_SANDBOX ((uint32_t)8)
...
/*
 ...
 will return TA_FAIL
 */
TURBOACTIVATE_API HRESULT TA_CC TA_PDetsFromByteArray(uint8_t * byteArr, size_t byteArrLen);
 ...
 */
#define TA_E_IN_SANDBOX                ((HRESULT)0x00000022L)
